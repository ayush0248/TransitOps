    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-zinc-400">Categorize operational spending: Maintenance, Toll, Insurance, Repair, and Other.</p>
        </div>
      ...
      <div className="p-12 rounded-2xl bg-zinc-900/40 border border-zinc-800 text-center space-y-3">
        ...
        <h3 className="text-lg font-bold text-white">Expense Tracking Ready</h3>
        <p className="text-sm text-zinc-400 max-w-md mx-auto">
          Aggregates financial overhead per vehicle to compute net profit and ROI ratios.
        </p>
      </div>
    </div>
  );
